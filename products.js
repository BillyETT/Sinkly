...
const SINKLY_PRODUCTS = [
  ...
  // ── KITCHEN SINKS — Farmhouse ───────────────
  {
    ...
    category: 'Kitchen Sinks', page: 'kitchen-sinks.html', price: 549, salePrice: null,
  ...
  // ── KITCHEN SINKS — Single Bowl (multi-color) ─
  {
    ...
    category: 'Kitchen Sinks', page: 'kitchen-sinks.html', price: 449, salePrice: 359,
    variants: [
  ...
  // ── KITCHEN SINKS — Single Bowl (stainless only) ─
  {
    ...
    category: 'Kitchen Sinks', page: 'kitchen-sinks.html', price: 299, salePrice: null,
  ...
  },
  {
    ...
    category: 'Kitchen Sinks', page: 'kitchen-sinks.html', price: 329, salePrice: null,
  ...
  },
  {
    ...
    category: 'Kitchen Sinks', page: 'kitchen-sinks.html', price: 349, salePrice: null,
  ...
  },
  {
    ...
    category: 'Kitchen Sinks', page: 'kitchen-sinks.html', price: 369, salePrice: null,
  ...
  // ── KITCHEN SINKS — Double Bowl (multi-color) ─
  {
    ...
    category: 'Kitchen Sinks', page: 'kitchen-sinks.html', price: 499, salePrice: null,
    variants: [
  ...
  },
  {
    ...
    category: 'Kitchen Sinks', page: 'kitchen-sinks.html', price: 469, salePrice: null,
    variants: [
  ...
  // ── KITCHEN SINKS — Double Bowl (stainless only) ─
  {
    ...
    category: 'Kitchen Sinks', page: 'kitchen-sinks.html', price: 399, salePrice: null,
  ...
  },
  {
    ...
    category: 'Kitchen Sinks', page: 'kitchen-sinks.html', price: 419, salePrice: null,
  ...
  },
  {
    ...
    category: 'Kitchen Sinks', page: 'kitchen-sinks.html', price: 429, salePrice: null,
  ...
  },
  {
    ...
    category: 'Kitchen Sinks', page: 'kitchen-sinks.html', price: 449, salePrice: null,
  ...
  },
  {
    ...
    category: 'Kitchen Sinks', page: 'kitchen-sinks.html', price: 479, salePrice: null,
  ...
  // ── KITCHEN SINKS — Workstation ─────────────
  {
    ...
    category: 'Kitchen Sinks', page: 'kitchen-sinks.html', price: 649, salePrice: 519,
    variants: [
...

  {
    ...
    category: 'Kitchen Faucets', page: 'kitchen-faucets.html', price: 199, salePrice: null,
    variants: [
  ...
  },
  {
    ...
    category: 'Kitchen Faucets', page: 'kitchen-faucets.html', price: 349, salePrice: null,
    variants: [
  ...
  },
  {
    ...
    category: 'Kitchen Faucets', page: 'kitchen-faucets.html', price: 229, salePrice: null,
    variants: [
  ...
  },
  {
    ...
    category: 'Kitchen Faucets', page: 'kitchen-faucets.html', price: 189, salePrice: null,
    variants: [
  ...
  },
  {
    ...
    category: 'Kitchen Faucets', page: 'kitchen-faucets.html', price: 209, salePrice: null,
    variants: [
  ...
  },
  {
    ...
    category: 'Kitchen Faucets', page: 'kitchen-faucets.html', price: 219, salePrice: null,
    variants: [
  ...
  },
  {
    ...
    category: 'Kitchen Faucets', page: 'kitchen-faucets.html', price: 179, salePrice: null,
    variants: [
  ...
  },
  {
    ...
    category: 'Kitchen Faucets', page: 'kitchen-faucets.html', price: 169, salePrice: null,
    variants: [
  ...
  // 30001 — Pull-out single handle
  {
    ...
    category: 'Bathroom Faucets', page: 'bathroom-faucets.html', price: 149, salePrice: null,
  ...
  // 30002 — Waterfall single handle (tall)
  {
    ...
    category: 'Bathroom Faucets', page: 'bathroom-faucets.html', price: 179, salePrice: null,
  ...
  // 30003 — No specs
  {
    ...
    category: 'Bathroom Faucets', page: 'bathroom-faucets.html', price: 139, salePrice: null,
  ...
  // 30005 — Tall spout, vessel
  {
    ...
    category: 'Bathroom Faucets', page: 'bathroom-faucets.html', price: 159, salePrice: null,
  ...
  // 30006 — H59 brass, pull-out capable
  {
    ...
    category: 'Bathroom Faucets', page: 'bathroom-faucets.html', price: 169, salePrice: null,
  ...
  // 30007 — Wall-mount, tall
  {
    ...
    category: 'Bathroom Faucets', page: 'bathroom-faucets.html', price: 259, salePrice: null,
  ...
  // 30010 — Vessel with deck plate
  {
    ...
    category: 'Bathroom Faucets', page: 'bathroom-faucets.html', price: 189, salePrice: null,
  ...
  // 30014 — Touchless motion sensor
  {
    ...
    category: 'Bathroom Faucets', page: 'bathroom-faucets.html', price: 299, salePrice: null,
  ...
  // 30017 — Widespread two-handle (Black + Brushed Nickel)
  {
    id: 'bf-30017', name: 'Widespread Two-Handle Faucet', type: 'Widespread',
    category: 'Bathroom Faucets', page: 'bathroom-faucets.html', price: 249, salePrice: 199,
    variants: [
